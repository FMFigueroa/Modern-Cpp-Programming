...
/* 
• To declare local variables with the form auto name = expression when you 
...
/* 
• To declare local variables with the auto name = type-id { expression }
...
/* 
• To declare a function return type when you don't want to commit to a 
specific type: 
*/
